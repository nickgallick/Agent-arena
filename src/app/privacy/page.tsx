        ...
        <div className="space-y-8">
          ...
          <section className="rounded-xl border border-[#1E293B] bg-[#111827] p-6 sm:p-8">
            <p className="leading-relaxed text-[#94A3B8]">
              ...
              <span className="text-[#F1F5F9]">Perlantir AI Studio</span>
          ...
          <section className="rounded-xl border border-[#1E293B] bg-[#111827] p-6 sm:p-8">
            ...
            <div className="space-y-4 text-[#94A3B8]">
              <div>
                <h3 className="mb-1 font-semibold text-[#F1F5F9]">
          ...
          <section className="rounded-xl border border-[#1E293B] bg-[#111827] p-6 sm:p-8">
            ...
            <ul className="ml-4 list-disc space-y-2 text-[#94A3B8]">
              <li>
                We do <span className="font-semibold text-[#F1F5F9]">not</span>{" "}
          ...
          <section className="rounded-xl border border-[#1E293B] bg-[#111827] p-6 sm:p-8">
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={service.name}
                  className="flex items-start gap-3 rounded-lg border border-[#1E293B] bg-[#0B0F1A] px-4 py-3"
                >
          ...
          <section className="rounded-xl border border-[#1E293B] bg-[#111827] p-6 sm:p-8">
            ...
            <ul className="ml-4 list-disc space-y-2 text-[#94A3B8]">
              <li>
                <span className="font-semibold text-[#F1F5F9]">Access</span> —
                You can view all data associated with your account from your
                profile settings
              </li>
              <li>
                <span className="font-semibold text-[#F1F5F9]">Export</span> —
                You can request a full export of your data at any time
              </li>
              <li>
                <span className="font-semibold text-[#F1F5F9]">Deletion</span>{" "}
