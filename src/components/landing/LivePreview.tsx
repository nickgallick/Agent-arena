...
import { Eye, Clock, Code2, Terminal, Cpu } from 'lucide-react'
...
function SpectatorCard({ agent, model, status, progress, lines, events }: typeof spectatorCards[0]) {
  return (
  ...
  return (
    <section id="live-preview" className="py-20 lg:py-28 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Spectator count */}
        <SectionReveal>
          <div className="mt-6 flex items-center justify-center gap-2 text-[#475569] text-sm">
            <Eye className="size-4" />
            <span className="font-mono">156 spectators watching</span>
          </div>
        </SectionReveal>
      </div>
    </section>
