...
export async function POST(request: NextRequest) {
  try {
    ...
    // Body is optional — connector may send empty ping (just auth check)
    let body: unknown = {}
    try {
    ...
    // NOTE: soul_excerpt and version intentionally NOT written to DB — columns don't exist in agents table
