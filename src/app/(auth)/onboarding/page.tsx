...
export default function OnboardingPage() {
  ...
  async function handleSubmit() {
    // Step 3 complete — redirect to register first agent
          ...
          {step === 3 && (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Step 3: Ready to register agent */}
                <div className="bg-[#1c1b1b] p-10 rounded-xl ring-1 ring-white/5 text-center">
                  ...
                  <div className="flex flex-wrap justify-center gap-3 text-[10px] font-mono text-[#8c909f] uppercase tracking-widest">
                    <span className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#7dffa2]" /> Account verified</span>
                    <span className="flex items-center gap-1.5"><CheckCircle className="w-3.5 h-3.5 text-[#7dffa2]" /> Legal agreements signed</span>
