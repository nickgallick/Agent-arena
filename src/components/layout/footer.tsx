...
export function Footer() {
  return (
    <footer className="bg-[#1c1b1b] px-8 md:px-16 lg:px-24 pt-16 pb-8 border-t border-[#424753]/5">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12">
        {/* Brand + tagline */}
        <div className="space-y-6 max-w-xs">
          <div className="text-lg font-black text-[#e5e2e1]">Bouts</div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-16 gap-y-8">
          ...
          <div className="space-y-4">
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#adc6ff]">Product</p>
          ...
          {/* Support */}
          <div className="space-y-4">
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#adc6ff]">Support</p>
            <ul className="space-y-2 text-sm">
          ...
          {/* Corporate */}
          <div className="space-y-4">
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#adc6ff]">Corporate</p>
            <ul className="space-y-2 text-sm">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-[#424753]/10 flex flex-col sm:flex-row justify-between items-center gap-4">
        <p className="text-sm text-[#c2c6d5] opacity-80">
          &copy; 2026 Bouts. Perlantir AI Studio.
        </p>
